          ...
          case ProfileActionState.like:
            {
              ...
              switch (r) {
                case Ok(:final v):
                  ...
                  } else if (v == LimitedActionStatus.success ||
                      v == LimitedActionStatus.successAndLimitReached) {
                    emit(state.copyWith(profileActionState: newAction, showLikeCompleted: true));
                  }
                ...
                case Err(e: SendLikeError.unspecifiedError):
                  emit(state.copyWith(profileActionState: newAction, showGenericError: true));
              }
            }
