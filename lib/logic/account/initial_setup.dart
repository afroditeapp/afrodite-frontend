          ...
          profileImages.add(
            ImageSelected(
              AccountImageId(
                ...
                rejectedCategory: entry.rejectedCategory,
        ...
        if (img is ImageSelected) {
          entries.add(
            ProfilePictureEntry(
              ...
              moderationState: img.id.moderationState,
              rejectedCategory: img.id.rejectedCategory,
              rejectedDetails: img.id.rejectedDetails,
