...
mixin _$BottomNavigationStateData {
  ...
  bool get isTappedAgainProfile => throw _privateConstructorErrorBottomNavigationStateData;
  bool get isTappedAgainLikes => throw _privateConstructorErrorBottomNavigationStateData;
  bool get isTappedAgainChats => throw _privateConstructorErrorBottomNavigationStateData;
  bool get isTappedAgainSettings => throw _privateConstructorErrorBottomNavigationStateData;
  ...
  BottomNavigationStateData copyWith({
    ...
    bool? isTappedAgainProfile,
    bool? isTappedAgainLikes,
    bool? isTappedAgainChats,
    bool? isTappedAgainSettings,
...
class _$BottomNavigationStateDataImpl with DiagnosticableTreeMixin implements _BottomNavigationStateData {
  ...
  static const bool _isTappedAgainProfileDefaultValue = false;
  ...
  _$BottomNavigationStateDataImpl({
    ...
    this.isTappedAgainProfile = _isTappedAgainProfileDefaultValue,
    this.isTappedAgainLikes = _isTappedAgainLikesDefaultValue,
    this.isTappedAgainChats = _isTappedAgainChatsDefaultValue,
    this.isTappedAgainSettings = _isTappedAgainSettingsDefaultValue,
  });
  ...
  @override
  final bool isTappedAgainProfile;
  @override
  final bool isTappedAgainLikes;
  @override
  final bool isTappedAgainChats;
  @override
  final bool isTappedAgainSettings;

  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'BottomNavigationStateData(screen: $screen, isScrolledProfile: $isScrolledProfile, isScrolledLikes: $isScrolledLikes, isScrolledChats: $isScrolledChats, isScrolledSettings: $isScrolledSettings, isTappedAgainProfile: $isTappedAgainProfile, isTappedAgainLikes: $isTappedAgainLikes, isTappedAgainChats: $isTappedAgainChats, isTappedAgainSettings: $isTappedAgainSettings)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('isTappedAgainProfile', isTappedAgainProfile))
      ..add(DiagnosticsProperty('isTappedAgainLikes', isTappedAgainLikes))
      ..add(DiagnosticsProperty('isTappedAgainChats', isTappedAgainChats))
      ..add(DiagnosticsProperty('isTappedAgainSettings', isTappedAgainSettings));
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
      (other.runtimeType == runtimeType &&
        ...
        (identical(other.isTappedAgainProfile, isTappedAgainProfile) ||
          other.isTappedAgainProfile == isTappedAgainProfile) &&
        (identical(other.isTappedAgainLikes, isTappedAgainLikes) ||
          other.isTappedAgainLikes == isTappedAgainLikes) &&
        (identical(other.isTappedAgainChats, isTappedAgainChats) ||
          other.isTappedAgainChats == isTappedAgainChats) &&
        (identical(other.isTappedAgainSettings, isTappedAgainSettings) ||
          other.isTappedAgainSettings == isTappedAgainSettings)
    );
  }
  ...
  int get hashCode => Object.hash(
    ...
    isScrolledChats,
    isScrolledSettings,
    isTappedAgainProfile,
    isTappedAgainLikes,
    isTappedAgainChats,
    isTappedAgainSettings,
  );
  ...
  BottomNavigationStateData copyWith({
    ...
    Object? isTappedAgainProfile,
    Object? isTappedAgainLikes,
    Object? isTappedAgainChats,
    Object? isTappedAgainSettings,
  }) => _$BottomNavigationStateDataImpl(
    ...
    isTappedAgainProfile: (isTappedAgainProfile ?? this.isTappedAgainProfile) as bool,
    isTappedAgainLikes: (isTappedAgainLikes ?? this.isTappedAgainLikes) as bool,
    isTappedAgainChats: (isTappedAgainChats ?? this.isTappedAgainChats) as bool,
    isTappedAgainSettings: (isTappedAgainSettings ?? this.isTappedAgainSettings) as bool,
  );
}
