...
class EditReportProcessingProfileContentConfigPage
    extends MyScreenPageLimited<AdminBotReportProcessingProfileContentConfig> {
  EditReportProcessingProfileContentConfigPage(AdminBotReportProcessingProfileContentConfig config)
    : super(builder: (closer) => EditReportProcessingProfileContentConfigScreen(config, closer));
}

class EditReportProcessingProfileContentConfigScreen extends StatefulWidget {
  final AdminBotReportProcessingProfileContentConfig initialConfig;
  final PageCloser<AdminBotReportProcessingProfileContentConfig> closer;
  const EditReportProcessingProfileContentConfigScreen(
    this.initialConfig,
    this.closer, {
    super.key,
  });
  ...
  @override
  State<EditReportProcessingProfileContentConfigScreen> createState() =>
      _EditReportProcessingProfileContentConfigScreenState();
}

class _EditReportProcessingProfileContentConfigScreenState
    extends State<EditReportProcessingProfileContentConfigScreen> {
  late AdminBotReportProcessingProfileContentConfig _config;
  ...
  Widget _scaffold(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Report Profile Content Config")),
      body: Form(
        key: _formKey,
