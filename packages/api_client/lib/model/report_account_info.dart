...
class ReportAccountInfo {
  ...
  static ReportAccountInfo? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'age'), 'Required key "ReportAccountInfo[age]" is missing from JSON.');
        assert(json[r'age'] != null, 'Required key "ReportAccountInfo[age]" has a null value in JSON.');
        return true;
      }());
