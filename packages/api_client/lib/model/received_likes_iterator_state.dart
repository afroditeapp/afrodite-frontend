...
class ReceivedLikesIteratorState {
  ...
  ReceivedLikeId? previousIdAtReset;
  ...
  @override
  String toString() => 'ReceivedLikesIteratorState[idAtReset=$idAtReset, page=$page, previousIdAtReset=$previousIdAtReset]';
  ...
  static ReceivedLikesIteratorState? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ReceivedLikesIteratorState(
        ...
        previousIdAtReset: ReceivedLikeId.fromJson(json[r'previous_id_at_reset']),
      );
    }
    return null;
  }
