...
class MarkReceivedLikesViewed {
  ...
  static MarkReceivedLikesViewed? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'v'), 'Required key "MarkReceivedLikesViewed[v]" is missing from JSON.');
        assert(json[r'v'] != null, 'Required key "MarkReceivedLikesViewed[v]" has a null value in JSON.');
        return true;
      }());
