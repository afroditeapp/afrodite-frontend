...
class GetReportList {
  ...
  static GetReportList? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'values'), 'Required key "GetReportList[values]" is missing from JSON.');
        assert(json[r'values'] != null, 'Required key "GetReportList[values]" has a null value in JSON.');
        return true;
      }());
