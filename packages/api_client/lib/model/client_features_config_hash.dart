...
class ClientFeaturesConfigHash {
  ...
  static ClientFeaturesConfigHash? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'h'), 'Required key "ClientFeaturesConfigHash[h]" is missing from JSON.');
        assert(json[r'h'] != null, 'Required key "ClientFeaturesConfigHash[h]" has a null value in JSON.');
        return true;
      }());
