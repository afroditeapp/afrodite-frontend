...
class InfoBannerUrlButton {
  ...
  static InfoBannerUrlButton? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'text'), 'Required key "InfoBannerUrlButton[text]" is missing from JSON.');
        assert(json[r'text'] != null, 'Required key "InfoBannerUrlButton[text]" has a null value in JSON.');
        assert(json.containsKey(r'url'), 'Required key "InfoBannerUrlButton[url]" is missing from JSON.');
        assert(json[r'url'] != null, 'Required key "InfoBannerUrlButton[url]" has a null value in JSON.');
        return true;
      }());
