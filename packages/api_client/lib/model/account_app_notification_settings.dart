...
class AccountAppNotificationSettings {
  ...
  static AccountAppNotificationSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'news'), 'Required key "AccountAppNotificationSettings[news]" is missing from JSON.');
        assert(json[r'news'] != null, 'Required key "AccountAppNotificationSettings[news]" has a null value in JSON.');
        return true;
      }());
