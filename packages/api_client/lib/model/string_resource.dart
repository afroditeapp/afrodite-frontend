...
class StringResource {
  ...
  static StringResource? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'default'), 'Required key "StringResource[default]" is missing from JSON.');
        assert(json[r'default'] != null, 'Required key "StringResource[default]" has a null value in JSON.');
        assert(json.containsKey(r'translations'), 'Required key "StringResource[translations]" is missing from JSON.');
        assert(json[r'translations'] != null, 'Required key "StringResource[translations]" has a null value in JSON.');
        return true;
      }());
