...
class AttributeHash {
  ...
  static AttributeHash? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'h'), 'Required key "AttributeHash[h]" is missing from JSON.');
        assert(json[r'h'] != null, 'Required key "AttributeHash[h]" has a null value in JSON.');
        return true;
      }());
