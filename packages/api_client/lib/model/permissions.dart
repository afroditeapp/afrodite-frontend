...
class Permissions {
  ...
  Permissions({
    ...
    this.adminCustomEmail = false,
    this.adminDeleteAccount = false,
    this.adminDeleteMediaContent = false,
    this.adminEditAssociationMembership = false,
    ...
    this.adminServerEditInfoBanners = false,
    this.adminServerEditMaintenanceNotification = false,
    this.adminServerEditServerConfig = false,
    ...
    this.adminServerShutdown = false,
    ...
    this.adminViewAssociationMembership = false,
    this.adminViewEmailAddress = false,
    this.adminViewLogin = false,
  ...
  bool adminCustomEmail;

  bool adminDeleteAccount;

  bool adminDeleteMediaContent;

  bool adminEditAssociationMembership;

  bool adminEditLogin;

  bool adminEditMediaContentFaceDetectedValue;

  bool adminEditMediaContentFaceVerifiedValue;
  ...
  bool adminServerEditInfoBanners;

  bool adminServerEditMaintenanceNotification;

  bool adminServerEditServerConfig;
  ...
  bool adminServerViewServerConfig;
  ...
  bool adminViewAssociationMembership;
  ...
  bool operator ==(Object other) => identical(this, other) || other is Permissions &&
    ...
    other.adminCustomEmail == adminCustomEmail &&
    other.adminDeleteAccount == adminDeleteAccount &&
    other.adminDeleteMediaContent == adminDeleteMediaContent &&
    other.adminEditAssociationMembership == adminEditAssociationMembership &&
    ...
    other.adminServerEditInfoBanners == adminServerEditInfoBanners &&
    other.adminServerEditMaintenanceNotification == adminServerEditMaintenanceNotification &&
    other.adminServerEditServerConfig == adminServerEditServerConfig &&
    ...
    other.adminServerShutdown == adminServerShutdown &&
    ...
    other.adminViewAssociationMembership == adminViewAssociationMembership &&
    other.adminViewEmailAddress == adminViewEmailAddress &&
    other.adminViewLogin == adminViewLogin &&
  ...
  int get hashCode =>
    ...
    (adminCustomEmail.hashCode) +
    (adminDeleteAccount.hashCode) +
    (adminDeleteMediaContent.hashCode) +
    (adminEditAssociationMembership.hashCode) +
    ...
    (adminServerEditInfoBanners.hashCode) +
    (adminServerEditMaintenanceNotification.hashCode) +
    (adminServerEditServerConfig.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      ...
      json[r'admin_server_edit_info_banners'] = this.adminServerEditInfoBanners;
      json[r'admin_server_edit_maintenance_notification'] = this.adminServerEditMaintenanceNotification;
      json[r'admin_server_edit_server_config'] = this.adminServerEditServerConfig;
      ...
      json[r'admin_server_shutdown'] = this.adminServerShutdown;
      ...
      json[r'admin_view_association_membership'] = this.adminViewAssociationMembership;
      json[r'admin_view_email_address'] = this.adminViewEmailAddress;
      json[r'admin_view_login'] = this.adminViewLogin;
  ...
  static Permissions? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Permissions(
        ...
        adminCustomEmail: mapValueOfType<bool>(json, r'admin_custom_email') ?? false,
        ...
        adminEditAssociationMembership: mapValueOfType<bool>(json, r'admin_edit_association_membership') ?? false,
        ...
        adminServerEditInfoBanners: mapValueOfType<bool>(json, r'admin_server_edit_info_banners') ?? false,
        adminServerEditMaintenanceNotification: mapValueOfType<bool>(json, r'admin_server_edit_maintenance_notification') ?? false,
        adminServerEditServerConfig: mapValueOfType<bool>(json, r'admin_server_edit_server_config') ?? false,
        ...
        adminServerShutdown: mapValueOfType<bool>(json, r'admin_server_shutdown') ?? false,
        ...
        adminViewAssociationMembership: mapValueOfType<bool>(json, r'admin_view_association_membership') ?? false,
        adminViewEmailAddress: mapValueOfType<bool>(json, r'admin_view_email_address') ?? false,
        adminViewLogin: mapValueOfType<bool>(json, r'admin_view_login') ?? false,
