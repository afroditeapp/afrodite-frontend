...
class ProfileTextMinCharactersFilter {
  ...
  static ProfileTextMinCharactersFilter? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'value'), 'Required key "ProfileTextMinCharactersFilter[value]" is missing from JSON.');
        assert(json[r'value'] != null, 'Required key "ProfileTextMinCharactersFilter[value]" has a null value in JSON.');
        return true;
      }());
