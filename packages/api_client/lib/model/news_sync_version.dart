...
class NewsSyncVersion {
  ...
  static NewsSyncVersion? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'version'), 'Required key "NewsSyncVersion[version]" is missing from JSON.');
        assert(json[r'version'] != null, 'Required key "NewsSyncVersion[version]" has a null value in JSON.');
        return true;
      }());
