...
class ProfileStringModerationQueuePage {
  ...
  static ProfileStringModerationQueuePage? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'values'), 'Required key "ProfileStringModerationQueuePage[values]" is missing from JSON.');
        assert(json[r'values'] != null, 'Required key "ProfileStringModerationQueuePage[values]" has a null value in JSON.');
        return true;
      }());
