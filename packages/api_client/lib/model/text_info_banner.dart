...
class TextInfoBanner {
  ...
  static TextInfoBanner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'body'), 'Required key "TextInfoBanner[body]" is missing from JSON.');
        assert(json[r'body'] != null, 'Required key "TextInfoBanner[body]" has a null value in JSON.');
        return true;
      }());
