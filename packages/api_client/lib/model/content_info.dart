...
class ContentInfo {
  ...
  static ContentInfo? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'cid'), 'Required key "ContentInfo[cid]" is missing from JSON.');
        assert(json[r'cid'] != null, 'Required key "ContentInfo[cid]" has a null value in JSON.');
        return true;
      }());
