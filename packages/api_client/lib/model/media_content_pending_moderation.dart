...
class MediaContentPendingModeration {
  ...
  static MediaContentPendingModeration? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'account_id'), 'Required key "MediaContentPendingModeration[account_id]" is missing from JSON.');
        assert(json[r'account_id'] != null, 'Required key "MediaContentPendingModeration[account_id]" has a null value in JSON.');
        assert(json.containsKey(r'content_id'), 'Required key "MediaContentPendingModeration[content_id]" is missing from JSON.');
        assert(json[r'content_id'] != null, 'Required key "MediaContentPendingModeration[content_id]" has a null value in JSON.');
        return true;
      }());
