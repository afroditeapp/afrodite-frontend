  ...
  static List<StatisticsProfileVisibility> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = StatisticsProfileVisibility.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [StatisticsProfileVisibility] to String,
/// and [decode] dynamic data back to [StatisticsProfileVisibility].
class StatisticsProfileVisibilityTypeTransformer {
  factory StatisticsProfileVisibilityTypeTransformer() => _instance ??= const StatisticsProfileVisibilityTypeTransformer._();
