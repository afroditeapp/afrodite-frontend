...
class ClientLanguage {
  ...
  static ClientLanguage? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'l'), 'Required key "ClientLanguage[l]" is missing from JSON.');
        assert(json[r'l'] != null, 'Required key "ClientLanguage[l]" has a null value in JSON.');
        return true;
      }());
