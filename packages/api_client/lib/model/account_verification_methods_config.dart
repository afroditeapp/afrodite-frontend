...
class AccountVerificationMethodsConfig {
  ...
  AccountVerificationMethodsConfig({
    this.debugAccept = false,
    this.debugReject = false,
    this.eudi = false,
  });
  ...
  bool operator ==(Object other) => identical(this, other) || other is AccountVerificationMethodsConfig &&
    other.debugAccept == debugAccept &&
    other.debugReject == debugReject &&
    other.eudi == eudi;

  @override
  int get hashCode =>
    // ignore: unnecessary_parenthesis
    (debugAccept.hashCode) +
    (debugReject.hashCode) +
    (eudi.hashCode);

  @override
  String toString() => 'AccountVerificationMethodsConfig[debugAccept=$debugAccept, debugReject=$debugReject, eudi=$eudi]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'debug_accept'] = this.debugAccept;
      json[r'debug_reject'] = this.debugReject;
  ...
  static AccountVerificationMethodsConfig? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return AccountVerificationMethodsConfig(
        debugAccept: mapValueOfType<bool>(json, r'debug_accept') ?? false,
        debugReject: mapValueOfType<bool>(json, r'debug_reject') ?? false,
