...
class GetProfileFilters {
  ...
  static GetProfileFilters? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'attribute_filters'), 'Required key "GetProfileFilters[attribute_filters]" is missing from JSON.');
        assert(json[r'attribute_filters'] != null, 'Required key "GetProfileFilters[attribute_filters]" has a null value in JSON.');
        return true;
      }());
