...
class NewsTranslationVersion {
  ...
  static NewsTranslationVersion? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'version'), 'Required key "NewsTranslationVersion[version]" is missing from JSON.');
        assert(json[r'version'] != null, 'Required key "NewsTranslationVersion[version]" has a null value in JSON.');
        return true;
      }());
