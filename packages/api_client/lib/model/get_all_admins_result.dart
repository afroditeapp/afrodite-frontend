...
class GetAllAdminsResult {
  ...
  static GetAllAdminsResult? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'admins'), 'Required key "GetAllAdminsResult[admins]" is missing from JSON.');
        assert(json[r'admins'] != null, 'Required key "GetAllAdminsResult[admins]" has a null value in JSON.');
        return true;
      }());
