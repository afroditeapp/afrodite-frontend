...
enum ProfileVisibility {
  ...
  const ProfileVisibility._(this._value);
  ...
  /// Returns the instance of [ProfileVisibility] that was successfully decoded
  /// from the passed [value] on success, null otherwise.
  static ProfileVisibility? fromJson(dynamic value) => ProfileVisibilityTypeTransformer().decode(value);

  /// Returns a [List] containing instances of [ProfileVisibility]
...
class ProfileVisibilityTypeTransformer {
  ...
  /// Encodes this enum as a value suitable for JSON.
  String encode(ProfileVisibility data) => data._value;
