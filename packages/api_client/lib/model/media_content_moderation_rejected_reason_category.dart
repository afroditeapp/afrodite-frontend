...
class MediaContentModerationRejectedReasonCategory {
  ...
  static MediaContentModerationRejectedReasonCategory? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'value'), 'Required key "MediaContentModerationRejectedReasonCategory[value]" is missing from JSON.');
        assert(json[r'value'] != null, 'Required key "MediaContentModerationRejectedReasonCategory[value]" has a null value in JSON.');
        return true;
      }());
