...
class MessageNumber {
  ...
  static MessageNumber? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'mn'), 'Required key "MessageNumber[mn]" is missing from JSON.');
        assert(json[r'mn'] != null, 'Required key "MessageNumber[mn]" has a null value in JSON.');
        return true;
      }());
