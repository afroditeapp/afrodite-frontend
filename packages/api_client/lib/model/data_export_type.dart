...
class DataExportType {
  /// Instantiate a new enum with the provided [value].
  const DataExportType._(this.value);
  ...
  static const user = DataExportType._(r'User');
  static const admin = DataExportType._(r'Admin');

  /// List of all possible values in this [enum][DataExportType].
  static const values = <DataExportType>[
    user,
    admin,
  ];
...
class DataExportTypeTypeTransformer {
  ...
  String encode(DataExportType data) => data.value;

  /// Decodes a [dynamic value][data] to a DataExportType.
  ///
  ...
  /// Singleton [DataExportTypeTypeTransformer] instance.
