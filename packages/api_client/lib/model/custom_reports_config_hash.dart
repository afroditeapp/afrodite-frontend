...
class CustomReportsConfigHash {
  ...
  static CustomReportsConfigHash? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'h'), 'Required key "CustomReportsConfigHash[h]" is missing from JSON.');
        assert(json[r'h'] != null, 'Required key "CustomReportsConfigHash[h]" has a null value in JSON.');
        return true;
      }());
