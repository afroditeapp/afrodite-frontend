...
class ProfileAttributeInfo {
  ...
  static ProfileAttributeInfo? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'h'), 'Required key "ProfileAttributeInfo[h]" is missing from JSON.');
        assert(json[r'h'] != null, 'Required key "ProfileAttributeInfo[h]" has a null value in JSON.');
        assert(json.containsKey(r'id'), 'Required key "ProfileAttributeInfo[id]" is missing from JSON.');
        assert(json[r'id'] != null, 'Required key "ProfileAttributeInfo[id]" has a null value in JSON.');
        return true;
      }());
