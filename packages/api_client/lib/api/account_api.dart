...
class AccountApi {
  ...
  ///
  /// * [PutSignInWithApple] putSignInWithApple (required):
  Future<PutSignInWithResult?> putSignInWithApple(PutSignInWithApple putSignInWithApple, { Future<void>? abortTrigger, }) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'PutSignInWithResult',) as PutSignInWithResult;
  ...
  ///
  /// * [PutSignInWithGoogle] putSignInWithGoogle (required):
  Future<PutSignInWithResult?> putSignInWithGoogle(PutSignInWithGoogle putSignInWithGoogle, { Future<void>? abortTrigger, }) async {
