...
*AccountAdminApi* | [**getAccountLoginSessionInfo**](doc//AccountAdminApi.md#getaccountloginsessioninfo) | **GET** /account_api/get_account_login_session_info/{aid} | Get login session info for specific account.
...
*ChatApi* | [**getPendingChatNotifications**](doc//ChatApi.md#getpendingchatnotifications) | **GET** /chat_api/pending_notifications | 
*ChatApi* | [**getPendingLatestSeenMessages**](doc//ChatApi.md#getpendinglatestseenmessages) | **GET** /chat_api/pending_latest_seen_messages | Get pending latest seen message numbers where the API caller is the message sender. Returns entries that the viewer has reported as seen but have not yet been delivered back to the sender.
...
*ChatApi* | [**postDeletePendingChatNotifications**](doc//ChatApi.md#postdeletependingchatnotifications) | **POST** /chat_api/pending_notifications/delete | 
*ChatApi* | [**postDeletePendingLatestSeenMessages**](doc//ChatApi.md#postdeletependinglatestseenmessages) | **POST** /chat_api/pending_latest_seen_messages/delete | Delete pending latest seen message entries.
...
*ChatApi* | [**postMarkMessageAsSeen**](doc//ChatApi.md#postmarkmessageasseen) | **POST** /chat_api/mark_message_as_seen | Mark received message as seen. Only latest message number is stored so client should mark the latest messages as seen.
...
*MediaAdminApi* | [**postSecurityContentVerifiedValue**](doc//MediaAdminApi.md#postsecuritycontentverifiedvalue) | **POST** /media_api/security_content_verified_value | Change security content verified value
...
## Documentation For Models
 ...
 - [ClientMessageType](doc//ClientMessageType.md)
 ...
 - [EmailRegistrationDomainLists](doc//EmailRegistrationDomainLists.md)
 - [EmailRegistrationPlatforms](doc//EmailRegistrationPlatforms.md)
 ...
 - [GetAccountLoginSessionInfo](doc//GetAccountLoginSessionInfo.md)
 ...
 - [GetContentProcessingState](doc//GetContentProcessingState.md)
 - [GetConversationId](doc//GetConversationId.md)
 - [GetCustomEmailConfig](doc//GetCustomEmailConfig.md)
 ...
 - [PutSignInWithResult](doc//PutSignInWithResult.md)
 ...
 - [SecurityContentAdminInfo](doc//SecurityContentAdminInfo.md)
 - [SeenMessage](doc//SeenMessage.md)
 - [SendCustomEmail](doc//SendCustomEmail.md)
