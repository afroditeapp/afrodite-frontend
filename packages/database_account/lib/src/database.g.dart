...
class ServerMaintenanceData extends DataClass
  ...
  @override
  int get hashCode =>
      Object.hash(id, startTime, endTime, showBadge, adminBotOffline);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $MyProfileTable extends schema.MyProfile
  ...
  @override
  late final GeneratedColumn<int> profileVerificationStatus =
      GeneratedColumn<int>(
  ...
  MyProfileCompanion toCompanion(bool nullToAbsent) {
    return MyProfileCompanion(
      ...
      profileVerificationStatus:
          ...
          ? const Value.absent()
          : Value(profileVerificationStatus),
...
class $ReceivedLikesGridTable extends schema.ReceivedLikesGrid
    with TableInfo<$ReceivedLikesGridTable, ReceivedLikesGridData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ReceivedLikesGridTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  late final GeneratedColumnWithTypeConverter<AccountId, String> accountId =
      GeneratedColumn<String>(
        ...
        type: DriftSqlType.string,
        requiredDuringInsert: true,
      ).withConverter<AccountId>($ReceivedLikesGridTable.$converteraccountId);
  @override
  List<GeneratedColumn> get $columns => [id, accountId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'received_likes_grid';
  @override
  VerificationContext validateIntegrity(
    Insertable<ReceivedLikesGridData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ReceivedLikesGridData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ReceivedLikesGridData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
      accountId: $ReceivedLikesGridTable.$converteraccountId.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}account_id'],
        )!,
  ...
  @override
  $ReceivedLikesGridTable createAlias(String alias) {
    return $ReceivedLikesGridTable(attachedDatabase, alias);
  }
...
class ReceivedLikesGridData extends DataClass
    implements Insertable<ReceivedLikesGridData> {
  final int id;
  final AccountId accountId;
  const ReceivedLikesGridData({required this.id, required this.accountId});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
    {
      map['account_id'] = Variable<String>(
        $ReceivedLikesGridTable.$converteraccountId.toSql(accountId),
      );
    }
    return map;
  }

  ReceivedLikesGridCompanion toCompanion(bool nullToAbsent) {
    return ReceivedLikesGridCompanion(
      id: Value(id),
      accountId: Value(accountId),
    );
  }

  factory ReceivedLikesGridData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ReceivedLikesGridData copyWith({int? id, AccountId? accountId}) =>
      ReceivedLikesGridData(
        id: id ?? this.id,
        accountId: accountId ?? this.accountId,
      );
  ReceivedLikesGridData copyWithCompanion(ReceivedLikesGridCompanion data) {
    return ReceivedLikesGridData(
      id: data.id.present ? data.id.value : this.id,
      accountId: data.accountId.present ? data.accountId.value : this.accountId,
    );
  ...
  @override
  String toString() {
    return (StringBuffer('ReceivedLikesGridData(')
          ..write('id: $id, ')
          ..write('accountId: $accountId')
          ..write(')'))
        .toString();
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ReceivedLikesGridData &&
          other.id == this.id &&
          other.accountId == this.accountId);
}

class ReceivedLikesGridCompanion
    extends UpdateCompanion<ReceivedLikesGridData> {
  final Value<int> id;
  final Value<AccountId> accountId;
  const ReceivedLikesGridCompanion({
    this.id = const Value.absent(),
    this.accountId = const Value.absent(),
  });
  ReceivedLikesGridCompanion.insert({
    this.id = const Value.absent(),
    required AccountId accountId,
  }) : accountId = Value(accountId);
  static Insertable<ReceivedLikesGridData> custom({
    Expression<int>? id,
    Expression<String>? accountId,
  }) {
    return RawValuesInsertable({
  ...
  ReceivedLikesGridCompanion copyWith({
    Value<int>? id,
    Value<AccountId>? accountId,
  }) {
    return ReceivedLikesGridCompanion(
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (accountId.present) {
      map['account_id'] = Variable<String>(
        $ReceivedLikesGridTable.$converteraccountId.toSql(accountId.value),
      );
    }
    return map;
  }
  ...
  @override
  String toString() {
    return (StringBuffer('ReceivedLikesGridCompanion(')
          ..write('id: $id, ')
          ..write('accountId: $accountId')
          ..write(')'))
        .toString();
...
class $ChatPrivacySettingsTable extends schema.ChatPrivacySettings
  ...
  static const VerificationMeta _messageStateSeenMeta = const VerificationMeta(
    'messageStateSeen',
  );
  @override
  late final GeneratedColumn<bool> messageStateSeen = GeneratedColumn<bool>(
    'message_state_seen',
    aliasedName,
    false,
    type: DriftSqlType.bool,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('message_state_seen')) {
      context.handle(
        _messageStateSeenMeta,
        messageStateSeen.isAcceptableOrUnknown(
          data['message_state_seen']!,
          _messageStateSeenMeta,
        ),
      );
    }
  ...
  ChatPrivacySetting map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ChatPrivacySetting(
      ...
      messageStateSeen: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}message_state_seen'],
      )!,
...
class ChatPrivacySetting extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
    map['message_state_seen'] = Variable<bool>(messageStateSeen);
  ...
  ChatPrivacySettingsCompanion toCompanion(bool nullToAbsent) {
    return ChatPrivacySettingsCompanion(
      id: Value(id),
      messageStateSeen: Value(messageStateSeen),
  ...
  factory ChatPrivacySetting.fromJson(
    ...
    return ChatPrivacySetting(
      id: serializer.fromJson<int>(json['id']),
      messageStateSeen: serializer.fromJson<bool>(json['messageStateSeen']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'messageStateSeen': serializer.toJson<bool>(messageStateSeen),
  ...
  ChatPrivacySetting copyWith({
    ...
    id: id ?? this.id,
    messageStateSeen: messageStateSeen ?? this.messageStateSeen,
  ...
  ChatPrivacySetting copyWithCompanion(ChatPrivacySettingsCompanion data) {
    return ChatPrivacySetting(
      id: data.id.present ? data.id.value : this.id,
      messageStateSeen: data.messageStateSeen.present
          ? data.messageStateSeen.value
  ...
  String toString() {
    return (StringBuffer('ChatPrivacySetting(')
          ..write('id: $id, ')
          ..write('messageStateSeen: $messageStateSeen, ')
...
class ChatPrivacySettingsCompanion extends UpdateCompanion<ChatPrivacySetting> {
  ...
  static Insertable<ChatPrivacySetting> custom({
    Expression<int>? id,
    Expression<bool>? messageStateSeen,
    Expression<bool>? typingIndicator,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (messageStateSeen != null) 'message_state_seen': messageStateSeen,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (messageStateSeen.present) {
      map['message_state_seen'] = Variable<bool>(messageStateSeen.value);
    }
...
class $MessageTable extends schema.Message
  ...
  static const VerificationMeta _serverSignedPgpMessageMeta =
      const VerificationMeta('serverSignedPgpMessage');
  @override
  late final GeneratedColumn<Uint8List> serverSignedPgpMessage =
      GeneratedColumn<Uint8List>(
        'server_signed_pgp_message',
        aliasedName,
        true,
        type: DriftSqlType.blob,
        requiredDuringInsert: false,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('server_signed_pgp_message')) {
      context.handle(
        _serverSignedPgpMessageMeta,
        serverSignedPgpMessage.isAcceptableOrUnknown(
          data['server_signed_pgp_message']!,
          _serverSignedPgpMessageMeta,
        ),
      );
    }
  ...
  MessageData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return MessageData(
      ...
      serverSignedPgpMessage: attachedDatabase.typeMapping.read(
        DriftSqlType.blob,
        data['${effectivePrefix}server_signed_pgp_message'],
      ),
...
class MessageData extends DataClass implements Insertable<MessageData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || serverSignedPgpMessage != null) {
      map['server_signed_pgp_message'] = Variable<Uint8List>(
        serverSignedPgpMessage,
      );
    }
  ...
  MessageCompanion toCompanion(bool nullToAbsent) {
    return MessageCompanion(
      ...
      sentUnixTime: sentUnixTime == null && nullToAbsent
          ? const Value.absent()
          : Value(sentUnixTime),
      serverSignedPgpMessage: serverSignedPgpMessage == null && nullToAbsent
          ? const Value.absent()
          : Value(serverSignedPgpMessage),
  ...
  factory MessageData.fromJson(
    ...
    return MessageData(
      ...
      serverSignedPgpMessage: serializer.fromJson<Uint8List?>(
        json['serverSignedPgpMessage'],
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'serverSignedPgpMessage': serializer.toJson<Uint8List?>(
        serverSignedPgpMessage,
      ),
  ...
  MessageData copyWith({
    ...
    Value<Uint8List?> serverSignedPgpMessage = const Value.absent(),
    ...
    serverSignedPgpMessage: serverSignedPgpMessage.present
        ? serverSignedPgpMessage.value
        : this.serverSignedPgpMessage,
  ...
  MessageData copyWithCompanion(MessageCompanion data) {
    return MessageData(
      ...
      sentUnixTime: data.sentUnixTime.present
          ...
          : this.sentUnixTime,
      serverSignedPgpMessage: data.serverSignedPgpMessage.present
          ? data.serverSignedPgpMessage.value
          : this.serverSignedPgpMessage,
  ...
  String toString() {
    return (StringBuffer('MessageData(')
          ...
          ..write('serverSignedPgpMessage: $serverSignedPgpMessage, ')
  ...
  int get hashCode => Object.hash(
    ...
    messageNumber,
    sentUnixTime,
    $driftBlobEquality.hash(serverSignedPgpMessage),
    deliveredUnixTime,
    seenUnixTime,
    messageId,
  );
...
class MessageCompanion extends UpdateCompanion<MessageData> {
  ...
  final Value<Uint8List?> serverSignedPgpMessage;
  ...
  const MessageCompanion({
    ...
    this.serverSignedPgpMessage = const Value.absent(),
  ...
  static Insertable<MessageData> custom({
    ...
    Expression<Uint8List>? serverSignedPgpMessage,
    ...
    return RawValuesInsertable({
      ...
      if (serverSignedPgpMessage != null)
        'server_signed_pgp_message': serverSignedPgpMessage,
  ...
  MessageCompanion copyWith({
    ...
    Value<Uint8List?>? serverSignedPgpMessage,
    ...
    return MessageCompanion(
      ...
      serverSignedPgpMessage:
          serverSignedPgpMessage ?? this.serverSignedPgpMessage,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (serverSignedPgpMessage.present) {
      map['server_signed_pgp_message'] = Variable<Uint8List>(
        serverSignedPgpMessage.value,
      );
    }
...
abstract class _$AccountDatabase extends GeneratedDatabase {
  ...
  late final DaoReadContentQuality daoReadContentQuality =
      DaoReadContentQuality(this as AccountDatabase);
  ...
  late final DaoWriteContentQuality daoWriteContentQuality =
      DaoWriteContentQuality(this as AccountDatabase);
