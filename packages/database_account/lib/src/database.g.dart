...
class $EditProfileImagePickerIndexTable
    extends schema.EditProfileImagePickerIndex
    with
        TableInfo<
          $EditProfileImagePickerIndexTable,
          EditProfileImagePickerIndexData
        > {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $EditProfileImagePickerIndexTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  static const VerificationMeta _editProfilePickImageToIndexMeta =
      const VerificationMeta('editProfilePickImageToIndex');
  @override
  late final GeneratedColumn<int> editProfilePickImageToIndex =
      GeneratedColumn<int>(
        'edit_profile_pick_image_to_index',
        aliasedName,
        true,
        type: DriftSqlType.int,
        requiredDuringInsert: false,
  ...
  @override
  List<GeneratedColumn> get $columns => [id, editProfilePickImageToIndex];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'edit_profile_image_picker_index';
  @override
  VerificationContext validateIntegrity(
    Insertable<EditProfileImagePickerIndexData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('edit_profile_pick_image_to_index')) {
      context.handle(
        _editProfilePickImageToIndexMeta,
        editProfilePickImageToIndex.isAcceptableOrUnknown(
          data['edit_profile_pick_image_to_index']!,
          _editProfilePickImageToIndexMeta,
        ),
      );
    }
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  EditProfileImagePickerIndexData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return EditProfileImagePickerIndexData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
      editProfilePickImageToIndex: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}edit_profile_pick_image_to_index'],
      ),
    );
  }

  @override
  $EditProfileImagePickerIndexTable createAlias(String alias) {
    return $EditProfileImagePickerIndexTable(attachedDatabase, alias);
  }
}

class EditProfileImagePickerIndexData extends DataClass
    implements Insertable<EditProfileImagePickerIndexData> {
  final int id;
  final int? editProfilePickImageToIndex;
  const EditProfileImagePickerIndexData({
    required this.id,
    this.editProfilePickImageToIndex,
  });
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
    if (!nullToAbsent || editProfilePickImageToIndex != null) {
      map['edit_profile_pick_image_to_index'] = Variable<int>(
        editProfilePickImageToIndex,
      );
    }
    return map;
  }

  EditProfileImagePickerIndexCompanion toCompanion(bool nullToAbsent) {
    return EditProfileImagePickerIndexCompanion(
      id: Value(id),
      editProfilePickImageToIndex:
          editProfilePickImageToIndex == null && nullToAbsent
          ? const Value.absent()
          : Value(editProfilePickImageToIndex),
    );
  }

  factory EditProfileImagePickerIndexData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return EditProfileImagePickerIndexData(
      id: serializer.fromJson<int>(json['id']),
      editProfilePickImageToIndex: serializer.fromJson<int?>(
        json['editProfilePickImageToIndex'],
      ),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'editProfilePickImageToIndex': serializer.toJson<int?>(
        editProfilePickImageToIndex,
      ),
    };
  }

  EditProfileImagePickerIndexData copyWith({
    int? id,
    Value<int?> editProfilePickImageToIndex = const Value.absent(),
  }) => EditProfileImagePickerIndexData(
    id: id ?? this.id,
    editProfilePickImageToIndex: editProfilePickImageToIndex.present
        ? editProfilePickImageToIndex.value
        : this.editProfilePickImageToIndex,
  );
  EditProfileImagePickerIndexData copyWithCompanion(
    EditProfileImagePickerIndexCompanion data,
  ) {
    return EditProfileImagePickerIndexData(
      id: data.id.present ? data.id.value : this.id,
      editProfilePickImageToIndex: data.editProfilePickImageToIndex.present
          ? data.editProfilePickImageToIndex.value
          : this.editProfilePickImageToIndex,
    );
  }
  ...
  @override
  String toString() {
    return (StringBuffer('EditProfileImagePickerIndexData(')
          ..write('id: $id, ')
          ..write('editProfilePickImageToIndex: $editProfilePickImageToIndex')
          ..write(')'))
        .toString();
  }

  @override
  int get hashCode => Object.hash(id, editProfilePickImageToIndex);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is EditProfileImagePickerIndexData &&
          other.id == this.id &&
          other.editProfilePickImageToIndex ==
              this.editProfilePickImageToIndex);
}

class EditProfileImagePickerIndexCompanion
    extends UpdateCompanion<EditProfileImagePickerIndexData> {
  final Value<int> id;
  final Value<int?> editProfilePickImageToIndex;
  const EditProfileImagePickerIndexCompanion({
    this.id = const Value.absent(),
    this.editProfilePickImageToIndex = const Value.absent(),
  });
  EditProfileImagePickerIndexCompanion.insert({
    this.id = const Value.absent(),
    this.editProfilePickImageToIndex = const Value.absent(),
  });
  static Insertable<EditProfileImagePickerIndexData> custom({
    Expression<int>? id,
    Expression<int>? editProfilePickImageToIndex,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (editProfilePickImageToIndex != null)
        'edit_profile_pick_image_to_index': editProfilePickImageToIndex,
    });
  }

  EditProfileImagePickerIndexCompanion copyWith({
    Value<int>? id,
    Value<int?>? editProfilePickImageToIndex,
  }) {
    return EditProfileImagePickerIndexCompanion(
      id: id ?? this.id,
      editProfilePickImageToIndex:
          editProfilePickImageToIndex ?? this.editProfilePickImageToIndex,
    );
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (editProfilePickImageToIndex.present) {
      map['edit_profile_pick_image_to_index'] = Variable<int>(
        editProfilePickImageToIndex.value,
      );
    }
  ...
  @override
  String toString() {
    return (StringBuffer('EditProfileImagePickerIndexCompanion(')
          ..write('id: $id, ')
          ..write('editProfilePickImageToIndex: $editProfilePickImageToIndex')
          ..write(')'))
        .toString();
