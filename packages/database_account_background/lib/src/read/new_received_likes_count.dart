...
class DaoReadNewReceivedLikesCount extends DatabaseAccessor<AccountBackgroundDatabase> with _$DaoReadNewReceivedLikesCountMixin {
  DaoReadNewReceivedLikesCount(super.db);

  Stream<int?> watchSyncVersionReceivedLikes() {
    return (select(newReceivedLikesCount)
