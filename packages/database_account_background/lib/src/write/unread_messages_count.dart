...
class DaoWriteUnreadMessagesCount extends DatabaseAccessor<AccountBackgroundDatabase>
    with _$DaoWriteUnreadMessagesCountMixin {
  ...
  Future<UnreadMessagesCount> incrementUnreadMessagesCount(api.AccountId accountId) async {
    return await transaction(() async {
      final currentUnreadMessageCount =
          await db.read.unreadMessagesCount.getUnreadMessageCount(accountId) ??
