...
class $ChatInfoDialogShownTable extends schema.ChatInfoDialogShown
    with TableInfo<$ChatInfoDialogShownTable, ChatInfoDialogShownData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ChatInfoDialogShownTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  @override
  List<GeneratedColumn> get $columns => [id, chatInfoDialogShown];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'chat_info_dialog_shown';
  @override
  VerificationContext validateIntegrity(
    Insertable<ChatInfoDialogShownData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ChatInfoDialogShownData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ChatInfoDialogShownData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  $ChatInfoDialogShownTable createAlias(String alias) {
    return $ChatInfoDialogShownTable(attachedDatabase, alias);
  }
}

class ChatInfoDialogShownData extends DataClass
    implements Insertable<ChatInfoDialogShownData> {
  final int id;
  ...
  ChatInfoDialogShownCompanion toCompanion(bool nullToAbsent) {
    return ChatInfoDialogShownCompanion(
      id: Value(id),
      chatInfoDialogShown: Value(chatInfoDialogShown),
    );
  }

  factory ChatInfoDialogShownData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ChatInfoDialogShownData copyWith({int? id, bool? chatInfoDialogShown}) =>
      ChatInfoDialogShownData(
        id: id ?? this.id,
        chatInfoDialogShown: chatInfoDialogShown ?? this.chatInfoDialogShown,
      );
  ChatInfoDialogShownData copyWithCompanion(ChatInfoDialogShownCompanion data) {
    return ChatInfoDialogShownData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('ChatInfoDialogShownData(')
          ..write('id: $id, ')
  ...
  @override
  int get hashCode => Object.hash(id, chatInfoDialogShown);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ChatInfoDialogShownData &&
          other.id == this.id &&
          other.chatInfoDialogShown == this.chatInfoDialogShown);
}

class ChatInfoDialogShownCompanion
    extends UpdateCompanion<ChatInfoDialogShownData> {
  final Value<int> id;
  final Value<bool> chatInfoDialogShown;
  const ChatInfoDialogShownCompanion({
    this.id = const Value.absent(),
  ...
  static Insertable<ChatInfoDialogShownData> custom({
    Expression<int>? id,
  ...
  ChatInfoDialogShownCompanion copyWith({
    Value<int>? id,
  ...
  @override
  String toString() {
    return (StringBuffer('ChatInfoDialogShownCompanion(')
          ..write('id: $id, ')
          ..write('chatInfoDialogShown: $chatInfoDialogShown')
          ..write(')'))
        .toString();
...
abstract class _$CommonForegroundDatabase extends GeneratedDatabase {
  ...
  late final $ChatInfoDialogShownTable chatInfoDialogShown =
      $ChatInfoDialogShownTable(this);
