...
class DaoReadMyMedia extends DatabaseAccessor<AccountForegroundDatabase> with _$DaoReadMyMediaMixin {
  ...
  Stream<MyContent?> watchMyCurrentSecurityContent() =>
    watchMyContent(-1);

  Stream<PrimaryProfileContent?> watchMyPrimaryProfileContent() =>
    Rx.combineLatest2(
