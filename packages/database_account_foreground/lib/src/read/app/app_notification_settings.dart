...
class DaoReadAppNotificationSettings extends DatabaseAccessor<AccountForegroundDatabase>
    with _$DaoReadAppNotificationSettingsMixin {
  ...
  Stream<api.ProfileAppNotificationSettings?> watchProfileAppNotificationSettings() =>
      _watchColumn((r) {
        ...
        if (profileStringModerationCompleted == null || automaticProfileSearch == null) {
          return null;
        }
  ...
  Stream<bool?> watchMessages() => _watchColumn((r) => r.messages);
  Stream<bool?> watchLikes() => _watchColumn((r) => r.likes);
  Stream<bool?> watchMediaContentModerationCompleted() =>
      _watchColumn((r) => r.mediaContentModerationCompleted);
  Stream<bool?> watchNews() => _watchColumn((r) => r.news);
