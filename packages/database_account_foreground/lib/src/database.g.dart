...
class $ImageSettingsTable extends schema.ImageSettings
    with TableInfo<$ImageSettingsTable, ImageSetting> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ImageSettingsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  static const VerificationMeta _imageCacheMaxBytesMeta =
      const VerificationMeta('imageCacheMaxBytes');
  @override
  late final GeneratedColumn<int> imageCacheMaxBytes = GeneratedColumn<int>(
  ...
  static const VerificationMeta _cacheFullSizedImagesMeta =
      const VerificationMeta('cacheFullSizedImages');
  @override
  late final GeneratedColumn<bool> cacheFullSizedImages = GeneratedColumn<bool>(
    'cache_full_sized_images',
    aliasedName,
    true,
    type: DriftSqlType.bool,
    requiredDuringInsert: false,
    defaultConstraints: GeneratedColumn.constraintIsAlways(
      'CHECK ("cache_full_sized_images" IN (0, 1))',
    ),
  );
  static const VerificationMeta _imageCacheDownscalingSizeMeta =
      const VerificationMeta('imageCacheDownscalingSize');
  @override
  late final GeneratedColumn<int> imageCacheDownscalingSize =
      GeneratedColumn<int>(
        'image_cache_downscaling_size',
        aliasedName,
        true,
        type: DriftSqlType.int,
        requiredDuringInsert: false,
  ...
  List<GeneratedColumn> get $columns => [
    id,
    imageCacheMaxBytes,
    cacheFullSizedImages,
    imageCacheDownscalingSize,
  ];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'image_settings';
  @override
  VerificationContext validateIntegrity(
    Insertable<ImageSetting> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('image_cache_max_bytes')) {
      context.handle(
        _imageCacheMaxBytesMeta,
        imageCacheMaxBytes.isAcceptableOrUnknown(
          data['image_cache_max_bytes']!,
          _imageCacheMaxBytesMeta,
        ),
      );
    }
    if (data.containsKey('cache_full_sized_images')) {
      context.handle(
        _cacheFullSizedImagesMeta,
        cacheFullSizedImages.isAcceptableOrUnknown(
          data['cache_full_sized_images']!,
          _cacheFullSizedImagesMeta,
        ),
      );
    }
    if (data.containsKey('image_cache_downscaling_size')) {
      context.handle(
        _imageCacheDownscalingSizeMeta,
        imageCacheDownscalingSize.isAcceptableOrUnknown(
          data['image_cache_downscaling_size']!,
          _imageCacheDownscalingSizeMeta,
        ),
      );
    }
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ImageSetting map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ImageSetting(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
      ...
      imageCacheMaxBytes: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}image_cache_max_bytes'],
      ),
      cacheFullSizedImages: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}cache_full_sized_images'],
      ),
      imageCacheDownscalingSize: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}image_cache_downscaling_size'],
      ),
    );
  }

  @override
  $ImageSettingsTable createAlias(String alias) {
    return $ImageSettingsTable(attachedDatabase, alias);
  }
}

class ImageSetting extends DataClass implements Insertable<ImageSetting> {
  final int id;
  final int? imageCacheMaxBytes;
  final bool? cacheFullSizedImages;
  final int? imageCacheDownscalingSize;
  const ImageSetting({
    required this.id,
    this.imageCacheMaxBytes,
    this.cacheFullSizedImages,
    this.imageCacheDownscalingSize,
  });
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
    if (!nullToAbsent || imageCacheMaxBytes != null) {
      map['image_cache_max_bytes'] = Variable<int>(imageCacheMaxBytes);
    }
    if (!nullToAbsent || cacheFullSizedImages != null) {
      map['cache_full_sized_images'] = Variable<bool>(cacheFullSizedImages);
    }
    if (!nullToAbsent || imageCacheDownscalingSize != null) {
      map['image_cache_downscaling_size'] = Variable<int>(
        imageCacheDownscalingSize,
      );
    }
    return map;
  ...
  ImageSettingsCompanion toCompanion(bool nullToAbsent) {
    return ImageSettingsCompanion(
      id: Value(id),
      imageCacheMaxBytes: imageCacheMaxBytes == null && nullToAbsent
          ? const Value.absent()
          : Value(imageCacheMaxBytes),
      cacheFullSizedImages: cacheFullSizedImages == null && nullToAbsent
          ? const Value.absent()
          : Value(cacheFullSizedImages),
      imageCacheDownscalingSize:
          imageCacheDownscalingSize == null && nullToAbsent
          ? const Value.absent()
          : Value(imageCacheDownscalingSize),
    );
  }

  factory ImageSetting.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return ImageSetting(
      id: serializer.fromJson<int>(json['id']),
      imageCacheMaxBytes: serializer.fromJson<int?>(json['imageCacheMaxBytes']),
      cacheFullSizedImages: serializer.fromJson<bool?>(
        json['cacheFullSizedImages'],
      ),
      imageCacheDownscalingSize: serializer.fromJson<int?>(
        json['imageCacheDownscalingSize'],
      ),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'imageCacheMaxBytes': serializer.toJson<int?>(imageCacheMaxBytes),
      'cacheFullSizedImages': serializer.toJson<bool?>(cacheFullSizedImages),
      'imageCacheDownscalingSize': serializer.toJson<int?>(
        imageCacheDownscalingSize,
      ),
    };
  }
  ...
  ImageSetting copyWith({
    int? id,
    Value<int?> imageCacheMaxBytes = const Value.absent(),
    Value<bool?> cacheFullSizedImages = const Value.absent(),
    Value<int?> imageCacheDownscalingSize = const Value.absent(),
  }) => ImageSetting(
    id: id ?? this.id,
    imageCacheMaxBytes: imageCacheMaxBytes.present
        ? imageCacheMaxBytes.value
        : this.imageCacheMaxBytes,
    cacheFullSizedImages: cacheFullSizedImages.present
        ? cacheFullSizedImages.value
        : this.cacheFullSizedImages,
    imageCacheDownscalingSize: imageCacheDownscalingSize.present
        ? imageCacheDownscalingSize.value
        : this.imageCacheDownscalingSize,
  );
  ImageSetting copyWithCompanion(ImageSettingsCompanion data) {
    return ImageSetting(
      id: data.id.present ? data.id.value : this.id,
      imageCacheMaxBytes: data.imageCacheMaxBytes.present
          ? data.imageCacheMaxBytes.value
          : this.imageCacheMaxBytes,
      cacheFullSizedImages: data.cacheFullSizedImages.present
          ? data.cacheFullSizedImages.value
          : this.cacheFullSizedImages,
      imageCacheDownscalingSize: data.imageCacheDownscalingSize.present
          ? data.imageCacheDownscalingSize.value
          : this.imageCacheDownscalingSize,
    );
  }
  ...
  @override
  String toString() {
    return (StringBuffer('ImageSetting(')
          ..write('id: $id, ')
          ..write('imageCacheMaxBytes: $imageCacheMaxBytes, ')
          ..write('cacheFullSizedImages: $cacheFullSizedImages, ')
          ..write('imageCacheDownscalingSize: $imageCacheDownscalingSize')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ImageSetting &&
          other.id == this.id &&
          other.imageCacheMaxBytes == this.imageCacheMaxBytes &&
          other.cacheFullSizedImages == this.cacheFullSizedImages &&
          other.imageCacheDownscalingSize == this.imageCacheDownscalingSize);
}

class ImageSettingsCompanion extends UpdateCompanion<ImageSetting> {
  final Value<int> id;
  final Value<int?> imageCacheMaxBytes;
  final Value<bool?> cacheFullSizedImages;
  final Value<int?> imageCacheDownscalingSize;
  const ImageSettingsCompanion({
    this.id = const Value.absent(),
    this.imageCacheMaxBytes = const Value.absent(),
    this.cacheFullSizedImages = const Value.absent(),
    this.imageCacheDownscalingSize = const Value.absent(),
  });
  ...
  static Insertable<ImageSetting> custom({
    Expression<int>? id,
    Expression<int>? imageCacheMaxBytes,
    Expression<bool>? cacheFullSizedImages,
    Expression<int>? imageCacheDownscalingSize,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (imageCacheMaxBytes != null)
        'image_cache_max_bytes': imageCacheMaxBytes,
      if (cacheFullSizedImages != null)
        'cache_full_sized_images': cacheFullSizedImages,
      if (imageCacheDownscalingSize != null)
        'image_cache_downscaling_size': imageCacheDownscalingSize,
    });
  }

  ImageSettingsCompanion copyWith({
    Value<int>? id,
    Value<int?>? imageCacheMaxBytes,
    Value<bool?>? cacheFullSizedImages,
    Value<int?>? imageCacheDownscalingSize,
  }) {
    return ImageSettingsCompanion(
      id: id ?? this.id,
      imageCacheMaxBytes: imageCacheMaxBytes ?? this.imageCacheMaxBytes,
      cacheFullSizedImages: cacheFullSizedImages ?? this.cacheFullSizedImages,
      imageCacheDownscalingSize:
          imageCacheDownscalingSize ?? this.imageCacheDownscalingSize,
    );
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (imageCacheMaxBytes.present) {
      map['image_cache_max_bytes'] = Variable<int>(imageCacheMaxBytes.value);
    }
    if (cacheFullSizedImages.present) {
      map['cache_full_sized_images'] = Variable<bool>(
        cacheFullSizedImages.value,
      );
    }
    if (imageCacheDownscalingSize.present) {
      map['image_cache_downscaling_size'] = Variable<int>(
        imageCacheDownscalingSize.value,
      );
    }
  ...
  @override
  String toString() {
    return (StringBuffer('ImageSettingsCompanion(')
          ..write('id: $id, ')
          ..write('imageCacheMaxBytes: $imageCacheMaxBytes, ')
          ..write('cacheFullSizedImages: $cacheFullSizedImages, ')
          ..write('imageCacheDownscalingSize: $imageCacheDownscalingSize')
...
class $IteratorSessionIdTable extends schema.IteratorSessionId
    with TableInfo<$IteratorSessionIdTable, IteratorSessionIdData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $IteratorSessionIdTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'iterator_session_id';
  @override
  VerificationContext validateIntegrity(
    Insertable<IteratorSessionIdData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  IteratorSessionIdData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return IteratorSessionIdData(
      ...
      profileIteratorSessionId: $IteratorSessionIdTable
  ...
  @override
  $IteratorSessionIdTable createAlias(String alias) {
    return $IteratorSessionIdTable(attachedDatabase, alias);
  }
...
class IteratorSessionIdData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || profileIteratorSessionId != null) {
      map['profile_iterator_session_id'] = Variable<int>(
        $IteratorSessionIdTable.$converterprofileIteratorSessionId.toSql(
          profileIteratorSessionId,
        ),
      );
    }
  ...
  IteratorSessionIdCompanion toCompanion(bool nullToAbsent) {
  ...
  factory IteratorSessionIdData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  IteratorSessionIdData copyWith({
    int? id,
...
class $ClientFeaturesConfigTable extends schema.ClientFeaturesConfig
  ...
  @override
  late final GeneratedColumnWithTypeConverter<ClientFeaturesFileHash?, String>
  clientFeaturesFileHash =
      GeneratedColumn<String>(
        ...
        requiredDuringInsert: false,
      ).withConverter<ClientFeaturesFileHash?>(
  ...
  ClientFeaturesConfigData map(
    ...
    return ClientFeaturesConfigData(
      ...
      clientFeaturesFileHash: $ClientFeaturesConfigTable
  ...
  static TypeConverter<ClientFeaturesFileHash?, String?>
...
class ClientFeaturesConfigData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || clientFeaturesFileHash != null) {
      map['client_features_file_hash'] = Variable<String>(
        $ClientFeaturesConfigTable.$converterclientFeaturesFileHash.toSql(
          clientFeaturesFileHash,
        ),
      );
    }
  ...
  @override
  int get hashCode =>
      Object.hash(id, clientFeaturesFileHash, clientFeaturesConfig);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $CustomReportsConfigTable extends schema.CustomReportsConfig
  ...
  @override
  late final GeneratedColumnWithTypeConverter<CustomReportsFileHash?, String>
  customReportsFileHash =
      GeneratedColumn<String>(
        ...
        type: DriftSqlType.string,
        requiredDuringInsert: false,
      ).withConverter<CustomReportsFileHash?>(
  ...
  CustomReportsConfigData map(
    ...
    return CustomReportsConfigData(
      ...
      customReportsFileHash: $CustomReportsConfigTable
  ...
  static TypeConverter<CustomReportsFileHash?, String?>
...
class CustomReportsConfigData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || customReportsFileHash != null) {
      map['custom_reports_file_hash'] = Variable<String>(
        $CustomReportsConfigTable.$convertercustomReportsFileHash.toSql(
          customReportsFileHash,
        ),
      );
    }
  ...
  @override
  int get hashCode =>
      Object.hash(id, customReportsFileHash, customReportsConfig);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $ProfileAttributesConfigAttributesTable
  ...
  @override
  late final GeneratedColumnWithTypeConverter<ProfileAttributeHash, String>
  attributeHash =
      GeneratedColumn<String>(
        'attribute_hash',
        aliasedName,
        ...
        type: DriftSqlType.string,
        requiredDuringInsert: true,
      ).withConverter<ProfileAttributeHash>(
...
class $ProfileContentTable extends schema.ProfileContent
  ...
  late final GeneratedColumnWithTypeConverter<AccountId, String> uuidAccountId =
      GeneratedColumn<String>(
        ...
        type: DriftSqlType.string,
        requiredDuringInsert: true,
      ).withConverter<AccountId>($ProfileContentTable.$converteruuidAccountId);
  static const VerificationMeta _contentIndexMeta = const VerificationMeta(
    'contentIndex',
  );
  @override
  ...
  ProfileContentData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ProfileContentData(
      uuidAccountId: $ProfileContentTable.$converteruuidAccountId.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}uuid_account_id'],
        )!,
...
class ProfileContentData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['uuid_account_id'] = Variable<String>(
        $ProfileContentTable.$converteruuidAccountId.toSql(uuidAccountId),
      );
    }
    map['content_index'] = Variable<int>(contentIndex);
    {
...
class ProfileContentCompanion extends UpdateCompanion<ProfileContentData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (uuidAccountId.present) {
      map['uuid_account_id'] = Variable<String>(
        $ProfileContentTable.$converteruuidAccountId.toSql(uuidAccountId.value),
      );
    }
    if (contentIndex.present) {
      map['content_index'] = Variable<int>(contentIndex.value);
...
class $ProfileStatesTable extends schema.ProfileStates
  ...
  late final GeneratedColumnWithTypeConverter<AccountId, String> uuidAccountId =
      GeneratedColumn<String>(
        ...
        type: DriftSqlType.string,
        requiredDuringInsert: true,
      ).withConverter<AccountId>($ProfileStatesTable.$converteruuidAccountId);
  @override
...
class $PublicKeyTable extends schema.PublicKey
  ...
  late final GeneratedColumnWithTypeConverter<AccountId, String> uuidAccountId =
      GeneratedColumn<String>(
        ...
        type: DriftSqlType.string,
        requiredDuringInsert: true,
      ).withConverter<AccountId>($PublicKeyTable.$converteruuidAccountId);
  ...
  PublicKeyData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return PublicKeyData(
      uuidAccountId: $PublicKeyTable.$converteruuidAccountId.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}uuid_account_id'],
        )!,
...
class PublicKeyData extends DataClass implements Insertable<PublicKeyData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['uuid_account_id'] = Variable<String>(
        $PublicKeyTable.$converteruuidAccountId.toSql(uuidAccountId),
      );
    }
    if (!nullToAbsent || publicKeyData != null) {
...
class PublicKeyCompanion extends UpdateCompanion<PublicKeyData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (uuidAccountId.present) {
      map['uuid_account_id'] = Variable<String>(
        $PublicKeyTable.$converteruuidAccountId.toSql(uuidAccountId.value),
      );
    }
    if (publicKeyData.present) {
...
abstract class _$AccountForegroundDatabase extends GeneratedDatabase {
  ...
  late final $ImageSettingsTable imageSettings = $ImageSettingsTable(this);
