...
class SoftwareInfo {
  ...
  SoftwareInfo({
    this.currentSoftware = const [],
  });

  List<BuildInfo> currentSoftware;
  ...
  int get hashCode =>
    ...
    (currentSoftware.hashCode);

  @override
  String toString() => 'SoftwareInfo[currentSoftware=$currentSoftware]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'current_software'] = this.currentSoftware;
    return json;
  }
